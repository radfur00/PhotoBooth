...
<body class="deselect">
	<div id="wrapper">
		...
		<div class="stages" id="start">
            <?php if($config['gallery']){ echo '<a class="gallery btn" href="#"><i class="fa fa-th"></i> <span data-l10n="gallery"></span></a>'; } ?>
			<div class="blurred">
			</div>
			<div class="inner">
				<div class="names"><hr class="small" /><hr>
                	<?php if($config['preview']){ echo '<iframe src="http://'.$ip.':'.$port.'" width="350" height="300" style="border: 0px;" scrolling="no" allowtransparency="true" overflow="hidden"></iframe>'; } ?>
                	<?php if($config['preview2']){ echo '<div data-l10n="startScreen2"></div>'; } ?>
                <hr><hr class="small" /></div>
		...
		<div class="stages" id="result">
			...
			<div class="resultInner hidden">
                <?php if($config['gallery']){ echo '<a href="#" class="btn gallery"><i class="fa fa-th"></i> <span data-l10n="gallery"></span></a>'; } ?>
			...
			<div class="galInner">
				...
				<div class="images" id="galimages">
					...
					foreach($imagelist as $image) {
						echo '<a href="/images/'.$image.'" data-size="500x300">
